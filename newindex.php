         ...
         <div class="panel-footer"> 
          ...
          <form method="POST" action="newindex.php">
            ...
            <li><select name="heuristic" class="form">
              ...
              <option value="3">H(pt, abs) = RPD(abs)</option>
              <option value="4">H(pt, abs) = pt | RD(abs)</option>
              <option value="5">H(pt, abs) = pt | RP(abs)</option>
              <option value="6">H(pt, abs) = pt | RPD(abs)</option>
              <option value="7">H(pt, abs) = pt | abs</option>
            </select>
          </li>
          </ul>
          ...
          <div class="panel-footer">
            ...
            <button class="btn btn-warning" type="submit">Run the engine!</a>
          ...
          <div class="panel panel-info">
            ...
            <div id="collapseOnePanel2" class="panel-collapse collapse in">
              <div class="panel-body">
                  ...
                  if( isset($_POST['title'])&& trim($_POST['title'] != '') && trim($_POST['abstract'] != '') )
                    { 
                        ob_start();

                      $command = 'python2 new.py ';
                      $command = $command.$_POST['title'];
                      passthru($command);
                      $output = ob_get_clean();
                      echo $output;
