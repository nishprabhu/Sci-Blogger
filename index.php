  ...
  <div class="container">
    ...
    <!-- Controls -->
      ...
      <div class="col-sm-16 col-lg-16">
        ...
        <div class="panel panel" id="panels" data-effect='helix'>
         <div class="panel-footer"> 
          ...
          <div class="panel-body">
            <textarea class="form-control" rows = "2" placeholder="Title..."><?php echo @$_REQUEST['abstract'];?></textarea>
            <br/>
            <textarea class="form-control" rows="4" placeholder="Type your abstract here"><?php echo @$_REQUEST['abstract'];?></textarea>
            <p align="left"><h6>or upload your pdf...</h6></p>
            <br/>
            <ul class="list-inline">
              <li><h5> Select heuristic function</h5></li>
            <li><select class="form">
              <option>H(pt, abs) = pt</option>
              <option>H(pt, abs) = RP(abs) </option>
              <option>H(pt, abs) = RPD(abs)</option>
              <option>H(pt, abs) = pt | RD(abs)</option>
              <option>H(pt, abs) = pt | RP(abs)</option>
              <option>H(pt, abs) = pt | RPD(abs)</option>
              <option>H(pt, abs) = pt | abs</option>
            </select>
          </li>
          </ul>
          ...
          <div class="panel-footer">
            ...
            <a class="btn btn-warning data-loading-text="Loading..." data-effect="fall" href="#"><i class="fa fa-check fa-fw "></i>Run the engine!</a>
        ...
        <div class="wrapper">
        <div  style="margin-left: 270px; display: none;" class="tube">
          <br/>
          <br/>
          <br/>
          <br/>
        ...
        <span align="center"><h4>Intermediate sequence <i>s</i>... </h4></span>
        <div class="panel-group" id="accordion-panel2">
          ...
          <br/>
         <span align="center"><h4>After the Neural Magic... </h4></span>
