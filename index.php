...
<h2 class="main-panel-title">Content Repurposing</h2>
...
<textarea type="text" name="abstract" value="" placeholder="Enter abstract" class="search-form-input" autocomplete="off" rows='10'  style="width:900px;height:200px; border:none;outline:0;min-width: 500px;" ><?php echo @$_REQUEST['abstract'];?></textarea>
<br/>
<div class="clearfix"></div>
<button type="submit" class="btn btn-primary btn-search-form submitbtn">Generate</button>
<?php
if(isset($_GET['title']))
{
include "process.php";
